...
export default function OwnerTermsConditions() {
	return (
...
const styles = StyleSheet.create({
	...
	headerText: { color: '#fff', fontSize: 24, fontWeight: 'bold', marginLeft: 8 },
	content: { flex: 1, paddingHorizontal: Math.min(width * 0.08, 30) },
	paragraph: { fontSize: 16, color: 'rgba(255,255,255,0.9)', lineHeight: 24, marginBottom: 12 },
});
