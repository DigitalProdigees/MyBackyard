...
export default function BookingDetails() {
  ...
  React.useEffect(() => {
    return () => {
      console.log('Booking details: Component unmounting, cleaning up state');
  ...
  // Reset form data whenever listingId changes
  React.useEffect(() => {
    console.log('Booking details: ListingId changed, resetting form data');
    setGuests('1');
    setHours('5');
    setSelectedDate(new Date());
    setStartTime('');
  ...
  // Additional reset after listing loads to ensure clean state
  React.useEffect(() => {
    if (listing) {
      console.log('Booking details: Listing loaded, ensuring form is reset');
      setGuests('1');
      setHours('5');
      setSelectedDate(new Date());
      setStartTime('');
