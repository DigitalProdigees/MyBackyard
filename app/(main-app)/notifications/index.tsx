...
import { UnreadBanner } from '@/app/components/UnreadBanner';
...
export default function Notifications() {
    ...
    React.useCallback(() => {
      ...
      const trackUnreadConversations = async () => {
        try {
          ...
          console.log('Main-app Notifications: Total unread conversations count:', unreadConversationsCount);
      ...
      const unsubscribe = onValue(conversationsRef, (snapshot) => {
        try {
          ...
          console.log('Main-app Notifications: Real-time unread conversations count:', unreadConversationsCount);
          setUnreadCount(unreadConversationsCount);
        } catch (error) {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right', 'bottom']}>
      ...
      {/* Right Mobile Frame Overlay (non-interactive so it doesn't block sidebar taps) */}
